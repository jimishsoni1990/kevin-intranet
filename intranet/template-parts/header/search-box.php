<?php
/**
 * Displays Search box in top header
 *
 * @package WordPress
 * @subpackage intranet
 * @since Intranet 1.0
            ...
            <div class="list pb-3">
                ...
                <div class="py-2">
                    <a class="dropdown-item py-2 d-flex align-items-center" href="../apps/e-commerce/landing/product-details.html">
                        <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3" src="<?php echo PHOENIX_ASSETS; ?>/img/products/60x60/3.png" alt="" /></div>
                        <div class="flex-1">
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center" href="../apps/e-commerce/landing/product-details.html">
                        <div class="file-thumbnail me-2"><img class="img-fluid" src="<?php echo PHOENIX_ASSETS; ?>/img/products/60x60/3.png" alt="" /></div>
                        <div class="flex-1">
                ...
                <div class="py-2">
                    <a class="dropdown-item py-2 d-flex align-items-center" href="members.html">
                        <div class="avatar avatar-l status-online me-2 text-900">
                            <img class="rounded-circle" src="<?php echo PHOENIX_ASSETS; ?>/img/team/40x40/10.webp" alt="" />
                        </div>
                        <div class="flex-1">
                    ...
                    <a class="dropdown-item py-2 d-flex align-items-center" href="members.html">
                        <div class="avatar avatar-l me-2 text-900">
                            <img class="rounded-circle" src="<?php echo PHOENIX_ASSETS; ?>/img/team/40x40/12.webp" alt="" />
                        </div>
                        <div class="flex-1">
