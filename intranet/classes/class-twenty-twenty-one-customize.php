...
if ( ! class_exists( 'intranet_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Intranet 1.0
	 */
	class intranet_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'intranet' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'intranet' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'intranet' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'intranet' ),
						'full'    => esc_html__( 'Full text', 'intranet' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'intranet_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new intranet_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'intranet' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
